...
if __name__ == "__main__":
    ...
    agent_name = "Critic" # "Executor" "Critic"

    execution_tools = ExecutionTools()
    evaluation_tools = EvaluationTools()

    # 建立工具清單
    all_tool_dicts = {**execution_tools.tool_dict, **evaluation_tools.tool_dict}  # 合併兩個工具字典
    tool_list = [all_tool_dicts[tool] for tool in agents_parameter[agent_name]["tool_list"] if tool in all_tool_dicts]
